...
require_once __DIR__ . '/../database_apoco/tbl/tageseinheiten_tbl.php';
...
if (checkRequiredFields()) {
	...
	$tageslimit = $_GET["tageslimit"];
	
	$db->connect();	
	$result = $db->updateTageslimit($user_id, $tageslimit);
	if ($result == 1) {
